(ns clj-datetime.local
  "Functions for working with local time without having to shift
   to/from utc, the preferred time zone of clj-datetime.core.
  ...
  (to-local-date-time (clj-datetime.core/date-time 1986 10 14 4 3 27 246))
